...
export default function WelcomePage() {
  ...
  // useTransform(theValueShouldBeTransformed, an array of break points, an array of matching point to different of value
  ...
  return (
    <>
      <header id="welcome-header">
        ...
        <motion.img
          // use style instead animate to watch the opacity change even the component won't be executed
